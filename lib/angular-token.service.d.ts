...
import { SignInData, RegisterData, UpdatePasswordData, ResetPasswordData, UserType, UserData, AuthData, ApiResponse, AngularTokenOptions } from './angular-token.model';
export declare class AngularTokenService implements CanActivate {
    ...
    signInOAuth(oAuthType: string, registration_token?: string): Observable<any>;
