...
class AngularTokenService {
     ...
     * @return {?}
     */
    signInOAuth(oAuthType, registration_token) {
        /** @type {?} */
        ...
        /** @type {?} */
        const authUrl = this.getOAuthUrl(oAuthPath, callbackUrl, oAuthWindowType, registration_token);
     ...
     * @return {?}
     */
    getOAuthUrl(oAuthPath, callbackUrl, windowType, registration_token) {
        /** @type {?} */
        let url;
